...
export default function LandingPage({ onStart }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-hidden relative selection:bg-violet-500/30">
      ...
      {/* --- Hero Section --- */}
      <main className="relative z-10 pt-32 pb-10 px-6 min-h-screen flex flex-col justify-center">
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            
            {/* Left Content */}
            <div className="flex-1 space-y-8 text-center lg:text-left">
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-violet-300 text-sm font-medium animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                <button 
                  onClick={onStart}
                  className="group relative px-8 py-4 bg-white text-slate-950 rounded-full font-bold text-lg hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] transition-all duration-300 overflow-hidden"
                >
                ...
                <button className="px-8 py-4 rounded-full font-semibold text-white border border-white/10 hover:bg-white/5 transition-all">
                  View Demo
                </button>
              </div>

              {/* Stats / Trust Badges */}
              <div className="pt-8 border-t border-white/5 flex items-center justify-center lg:justify-start gap-8 text-slate-500">
            ...
            <div className="flex-1 w-full max-w-lg lg:max-w-none perspective-1000 relative">
              {/* Background Glow */}
              <div className="absolute inset-0 bg-gradient-to-tr from-violet-600 to-fuchsia-600 blur-[80px] opacity-20 -z-10 rounded-full" />
              
              <div className="relative space-y-4">
                 {/* Card 1: Upload */}
                 <div className="transform translate-x-4 hover:-translate-y-2 transition-transform duration-500 bg-slate-900/60 backdrop-blur-xl border border-white/10 p-6 rounded-2xl shadow-2xl flex items-center space-x-4 group cursor-default">
                   <div className="p-3 bg-blue-500/20 rounded-xl text-blue-400 group-hover:text-blue-300 transition-colors">
                     <UploadCloud className="w-8 h-8" />
                   </div>
                   <div>
                     <h3 className="font-bold text-slate-200">Smart Upload</h3>
                     <p className="text-sm text-slate-500">Auto-detects data types & errors</p>
                   </div>
                 ...
                 <div className="transform -translate-x-4 scale-105 z-10 hover:-translate-y-2 transition-transform duration-500 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-violet-500/30 p-8 rounded-2xl shadow-[0_20px_50px_-12px_rgba(124,58,237,0.25)]">
                   <div className="flex justify-between items-start mb-6">
                     <div className="p-3 bg-violet-500 rounded-xl text-white shadow-lg shadow-violet-500/20">
                   ...
                   <h3 className="text-2xl font-bold text-white mb-2">Automated Cleaning</h3>
                 ...
                 {/* Card 3: Analysis */}
                 <div className="transform translate-x-8 hover:-translate-y-2 transition-transform duration-500 bg-slate-900/60 backdrop-blur-xl border border-white/10 p-6 rounded-2xl shadow-2xl flex items-center space-x-4 group cursor-default">
                   <div className="p-3 bg-pink-500/20 rounded-xl text-pink-400 group-hover:text-pink-300 transition-colors">
                     <BarChart2 className="w-8 h-8" />
                   </div>
                   <div>
                     <h3 className="font-bold text-slate-200">Deep Insights</h3>
                     <p className="text-sm text-slate-500">Correlation heatmaps & distributions</p>
                   </div>
                 </div>
              </div>
            </div>
